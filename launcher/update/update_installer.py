...
PERSISTENT_USER_FILES = (
    ...
    "_internal/injection/tools/ltk_patcher_host.exe",  # User-provided LTK patcher (optional)
    ...
    def prepare_installation(
        ...
        try:
            with open(batch_path, "w", encoding="utf-8") as batch:
                ...
                batch.write('robocopy "%SOURCE%" "%DEST%" /MIR /NFL /NDL /NJH /NJS /XD __pycache__ "Pengu Loader\\plugins" /XF config.ini cslol-dll.dll ltk_patcher_host.exe ltk_patcher_dll.dll hashes.game.txt >> "%LOG%" 2>&1\n')
